                    ...
                    try { 
                     ...
                     i.prototype.l_ = function () { 
                        try { 
                            ...
                            t.src = [this._e + "/", this.y_ + "/", 
                            "client.js?" + this._f].join(""), 
                        ...
                        i.prototype.p_ = function () { 
                            try { 
                                var t = this.m_(), i = document.createElement("link"); 
                                i.href = [this._e + "/", this.w_ + "/", 
                                "client_" + t + ".css?" + this._f].join(""), 
                                i.type = "text/css", 
                                i.rel = "stylesheet", 
                                this.__(i), document.getElementsByTagName("head")[0].appendChild(i) 
                            } catch (t) { } }, 
                            ...
                            i.prototype.I_ = function () { 
                                ...
                                "object" === ("undefined" == typeof CRISP_INCLUDE_ATTRS ? "undefined" : t(CRISP_INCLUDE_ATTRS)) ? this.E_ = CRISP_INCLUDE_ATTRS : this.E_ = {} },
                                 i.prototype.v_ = function () { try { this.r_ = [], "function" == typeof window.MutationObserver && "function" == typeof JSON.stringify && this.r_.push("browsing"), 
